...
function Ca(e, n, t) {
  return zn & 21
    ? (De(t, n) || ((t = Ps()), ($.lanes |= t), (Ln |= t), (e.baseState = !0)),
      n)
...
function Wa(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = qr(e, r);
    ...
    R |= 2;
    var o = Ka();
    (Z !== e || b !== n) && ((Ae = null), (lt = W() + 500), _n(e, n));
    do
      try {
        yd();
        break;
...
function Od() {
  const [e, n] = Ie.useState(''),
    ...
    [s, c] = Ie.useState(!0),
    h = async () => {
      const w = await (await fetch('https://swapi.dev/api/planets/')).json();
      console.log(l), o(w.results), r(w.results), c(!1), console.log(w.results);
    };
  Ie.useEffect(() => {
    h();
  }, []);
  const m = () => {
      window.localStorage.setItem('searchTerm', e);
    },
    p = () => {
      if (e.trim() === '') h(), c(!0);
      else {
        const g = l.filter((w) =>
          w.name.toLowerCase().includes(e.toLowerCase()),
        );
        r(g);
      }
      m();
    };
  if (u) throw new Error('The university colapse is started');
  return J.jsxs('div', {
    className: 'container',
    children: [
      J.jsxs('div', {
        className: 'seacrhBar_container',
        children: [
          J.jsx('input', {
            type: 'text',
            value: e,
          ...
          J.jsx('button', {
            ...
            children: 'Swith on Error',
          }),
        ],
      }),
      s
        ? J.jsx('div', { className: 'loading_container', children: 'Loading' })
        : J.jsx('div', {
            className: 'rearchResults_container',
            children: t.map((g) =>
              J.jsxs(
                'div',
                {
                  children: [
                    J.jsx('p', { children: g.name }),
                    J.jsxs('p', { children: ['Population: ', g.population] }),
                    J.jsxs('p', { children: ['Climate: ', g.climate] }),
                    J.jsxs('p', { children: ['Terrain: ', g.terrain] }),
                  ],
                },
                g.name,
              ),
...
function Dd() {
  return J.jsx(Rd, { children: J.jsx(Od, {}) });
}
Ql.createRoot(document.getElementById('root')).render(
  J.jsx(wc.StrictMode, { children: J.jsx(Dd, {}) }),
);
